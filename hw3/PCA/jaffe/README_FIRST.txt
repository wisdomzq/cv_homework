...
DOI: 10.5281/zenodo.3451523

Michael Lyons, Miyuki Kamachi, and Jiro Gyoba
Copyright, 1997

The original purpose of this data was for use in an experimental and computational study of facial expression perception by humans.

The dataset contains 213 images of facial expressions posed by 10 female posers. The images were rated on 6 emotion adjectives by 60 Japanese subjects. The image set was planned by Michael Lyons, Miyuki Kamachi, and Jiro Gyoba and photographed in 1996 at the Psychology Department of Kyushu University. We thank Reiko Kubota for assistance. 
...
michael (dt) lyons (you know) gmail (dt) com
...
Images are 8-bit grayscale, .tiff format, no compression.

LABELS
------

Letters 1,2 indicate the poser
(KM, KA, YM, KR, NM, MK, UY, KL, TM, NA)

Letters 4,5 denote the requested pose.
(NE, HA, SA, SU, AN, DI, FE)

The final digit is the pose number
(1,2,3,4,5)
...
It is important to realise that the poses are perceived as depicting 
admixtures of several emotions.

The following are mean semantic ratings on six expression words by 60 Japanese female students. 

5-level scale for each of the 6 adjectives (5-high, 1-low)
...
A separate rating experiment excluded fear poses and and the fear adjective
from the ratings survey. 

Other studies indicate that fear expressions are recognised with low reliably in Japan.
